module.exports = function (options) {
  ...
  var resolve = function (path, dependencies) {
    return Promise.all(dependencies.map(function (id) {
      ...
      // 3. Load module
      return modules[id] = locate(id).then(function (module) {
        return resolve(path.concat([id]), module.dependencies).spread(module.factory, createError.bind(null, Promise, id));
      });
    }));
  };
